    ...
    <div className="min-h-screen bg-beige">
        ...
        <div className="container-wide flex items-center justify-between">
          <div className="flex items-center">
            <img 
              ...
              className="h-8 mr-3"
            />
            <h1 className="text-xl font-semibold text-harbor">ContactTeam</h1>
          </div>
      ...
      <main className="container-wide py-8">
        <div className="bg-white rounded-xl shadow-sm p-6 md:p-8 animate-fade-in">
          {/* PRADŽIA: Lengvai redaguojamas turinys */}
          <h2 className="text-2xl font-semibold text-harbor mb-6">Apie mus</h2>
          ...
          <div className="space-y-6 text-gray-700">
            ...
            <div className="mt-8">
              <h3 className="text-xl font-medium text-harbor mb-4">Susisiekite su mumis</h3>
              
              <p>
                Jei turite klausimų ar pasiūlymų, mielai padėsime. Susisiekite su mumis elektroniniu paštu 
                <a href="mailto:pagalba.contactteam@gmail.com" className="text-teal hover:underline ml-1">
                  pagalba.contactteam@gmail.com
                </a> 
                arba telefonu <a href="tel:+37061658471" className="text-teal hover:underline">+370 616 58 471</a>.
              </p>
          ...
          {/* PABAIGA: Lengvai redaguojamas turinys */}
        </div>
      </main>
      
      <footer className="bg-white py-4 mt-8">
        <div className="container-wide text-center text-gray-500 text-sm">
          <p>&copy; {new Date().getFullYear()} ContactTeam. Visos teisės saugomos.</p>
        </div>
      </footer>
    </div>
  );
